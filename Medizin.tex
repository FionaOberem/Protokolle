...
%=============================VARIABLEN====================================
\newcommand{\fachschaft}{Medizin}
\newcommand{\gremium}{FSV} %Bei der Wahl gewähltes Gremium.
\newcommand{\wahltermin}{07.- 09.07.2020}
\newcommand{\sitzungstermin}{26.10.2020}
\newcommand{\vorsitz}{Fiona Oberem}
\newcommand{\anwesende}{\vorsitz\ (Vorsitz), Christoph Heinen, Ilka Fisser, Henrike Antony, Mara Weber}
...
\sym{1} Briefwahlanträge (Originale)
\end{itemize}

Mitgliederliste FSR fehlt
...
\begin{itemize}[label=$\Box$]
\sym{1} Briefwahlanträge wurden ordnungsgemäß behandelt.
\end{itemize}
